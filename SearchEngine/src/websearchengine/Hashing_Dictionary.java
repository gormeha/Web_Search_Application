...
public class Hashing_Dictionary {
	...
	public Hashtable<String, Value_Custom> dictionary_find() throws IOException {
		...
		File path = new File("C:\\Users\\mehag\\eclipse-workspace\\SearchEngine\\W3C Web Pages\\");
	...
	public static void convert() throws IOException,FileNotFoundException,NullPointerException {
		int Fnumber = 1;
		try {
			File directory = new File("C:\\Users\\mehag\\eclipse-workspace\\SearchEngine\\W3C Web Pages\\");
	...
	public static void convert_Html_To_Text(File _resourceFile,int F_num) throws IOException,FileNotFoundException,NullPointerException
	{
		try {
			...
			BufferedWriter out = new BufferedWriter(new FileWriter("C:\\Users\\mehag\\eclipse-workspace\\SearchEngine\\W3C Web Pages\\ConvertedTextFiles\\"+_resourceFile.getName()+".txt"));
			out.write(_doc.text());
			out.close();
